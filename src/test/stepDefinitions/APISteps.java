...
public class APISteps extends utils {
    ...
    public void i_send_a_post_request_with_payload(String name, String job) throws IOException {
     
        res = given().spec(requestSpecification()).body(data.createUserPayLoad(name, job));
    ...
    @Then("the API response should contain the user id")
    public void the_api_response_should_contain_the_user_id(){
